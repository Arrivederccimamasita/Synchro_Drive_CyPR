...
\newpage
	...
	Ahora se va a realizar el experimento correspondiente a la prueba solicitada para el trabajo donde se ha de suministrar una velocidad de desplazamiento constante y una velocidad de rotación con carácter senoidal. Para ello, se ha introducido una velocidad de desplazamiento de 0.5 cm/segundo y una senoide de 0.05 Hz de frecuencia y 0.2 de amplitud:
	\begin{figure}[h!]
		\centering
...
Aunque típicamente se ha modelado la dinámica de un sistema en la forma de una función de transferencia que relaciona los incrementos de la entrada del motor con incrementos de velocidad, en este problema, se han modelado los actuadores añadiendo las saturaciones en velocidades, tanto de desplazamiento como lineal, analogas a un robot real. \\
Estas saturaciones serán las que ya se comentaron anteriormente, es decir, se saturará la velocidad de desplazamiento a $=v \pm 30 cm/seg$ y la velocidad de orientacion a $\omega= \pm 15º/seg$.
...
donde $K_d$ es la constante de proporción para el control de la distancia a la que se encuentra el robot de la línea a seguir, $K_h$ la constante de proporción para el control de la orientación respecto a la línea, $\varphi^*$ y $\varphi$ los ángulos de orientación de referencia, calculada como $\varphi^*=atan(\frac{-a}{b})$, y actual, y $d$ la distancia del robot a la línea definida como $d=\frac{(a,b,c)\cdot(x,y,1)}{\sqrt{a^2+b^2}}$.\\
	...
	\begin{itemize}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.7\textwidth]{control_linea_1}
			\caption{Trayectoria realizada en control de seguimiento de línea}
		\end{figure}
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.7\textwidth]{control_linea_1_2}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=.8\textwidth]{control_linea_2}
		\caption{Trayectoria realizada en control de seguimiento de línea}
	\end{figure}
	\begin{figure}[h!]
		\centering
		\includegraphics[width=.8\textwidth]{control_linea_2_2}
		\caption{Velocidades de actuación a lo largo del tiempo de la trayectoria (arriba $\dot{\theta}$ y abajo $\omega$)}
	\end{figure}
...
\newpage
	...
	\begin{itemize}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.7\textwidth]{control_tray_1}
			\caption{Trayectoria realizada en control de seguimiento de trayectoria lineal}
		\end{figure}
	\newpage
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.7\textwidth]{control_tray_1_2}
			\caption{Velocidades de actuación a lo largo del tiempo de la trayectoria (arriba $\dot{\theta}$ y abajo $\omega$)}
		\end{figure}
...
Observando la gráfica de velocidades se puede concluir que el robot ha conseguido realizar dicho seguimiento a una velocidad de desplazamiento constante y, centrándose en la gráfica de $\omega$ se pueden observar los movimientos debidos al cambio de pendiente, cada cual más pequeño debido a que el cambio de pendiente es menor a cada cambio de recta.\\
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.7\textwidth]{control_tray_2}
			\caption{Trayectoria realizada en control de seguimiento de trayectoria interpolada}
		\end{figure}
\newpage
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.7\textwidth]{control_tray_2_2}
			\caption{Velocidades de actuación a lo largo del tiempo de la trayectoria (arriba $\dot{\theta}$ y abajo $\omega$)}
		\end{figure}
