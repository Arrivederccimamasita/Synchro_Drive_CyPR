...
switch (sel)
    ...
    figure
    subplot(2,1,1);plot(t,posx);xlabel('Tiempo (s)');ylabel('Posición cartesiana X (m)');title('Posición cartesiana X frente al tiempo');grid;subplot(2,1,2);plot(t,posy);xlabel('Tiempo (s)');ylabel('Posición cartesiana Y (m)');title('Posición cartesiana Y frente al tiempo');grid;
    case 2
    % MOVER POR UNA RECTA
    % Posiciones iniciales del integrador
     pos_init=[0;0;0];
