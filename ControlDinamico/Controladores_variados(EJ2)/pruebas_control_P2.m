...
%     figure
%     subplot(2,1,1);plot(t,posx);xlabel('Tiempo (s)');ylabel('Posici�n cartesiana X (m)');title('Posici�n cartesiana X frente al tiempo');xlim([0 50]);grid;subplot(2,1,2);plot(t,posy);xlabel('Tiempo (s)');ylabel('Posici�n cartesiana Y (m)');title('Posici�n cartesiana Y frente al tiempo');xlim([0 50]);grid;
     case 3
